...
exports.onDidChangeConfiguration = (change) => {
	...
	if (settings.sqf.enableOFP) { patterns.push({ "include": "#OFP" }); }
	if (settings.sqf.enableTOH) { patterns.push({ "include": "#TOH" }); }
	if (settings.sqf.enableARMA) { patterns.push({ "include": "#ARMA" }); }
	if (settings.sqf.enableARMA2) { patterns.push({ "include": "#ARMA2" }); }
	if (settings.sqf.enableARMA3) { patterns.push({ "include": "#ARMA3" }); }
	if (settings.sqf.enableCBA) { patterns.push({ "include": "#CBA" }); }
	if (settings.sqf.enableACE3) { patterns.push({ "include": "#ACE3" }); }
